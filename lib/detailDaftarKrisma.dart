...
import 'package:pelayanan_iman_katolik/confirmKrisma.dart';
...
class detailDaftarKrisma extends StatelessWidget {
  final name;
  final email;
  final namaGereja;
  var detailGereja;
  ...
  Future<List> callDb() async {
    detailGereja = await MongoDatabase.detailGerejaKrisma(namaGereja);
    print(detailGereja);
    return detailGereja;
  }
                      ...
                      RaisedButton(
                          onPressed: () async {
                            confirmKrisma(
                              detailGereja[0]['nama'],
                              idUser,
                              detailGereja[0]['GerejaKrisma'][0]['_id'],
                              this.name,
                              this.email,
                              this.namaGereja,
