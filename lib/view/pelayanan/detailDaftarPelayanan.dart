  ...
  Future callDb() async {
    ...
    if (jenisPelayanan == "Umum") {
      message = Messages(
          ...
          "REQUEST",
          Tasks(
              'cari pelayanan', [jenisPelayanan, jenisPencarian, idPelayanan]));
    } else if (jenisSelectedPelayanan == "Perminyakan" ||
      ...
      message = Messages(
          ...
          Tasks('cari pelayanan',
              [jenisSelectedPelayanan, jenisPencarian, idImam, idGereja]));
    } else {
      message = Messages(
          'Agent Page',
          'Agent Pencarian',
              ...
              FutureBuilder(
                  ...
                  builder: (context, AsyncSnapshot snapshot) {
                    ...
                    try {
                      ...
                      } else if (jenisSelectedPelayanan == "Tobat" ||
                                                            ...
                                                            children: <Widget>[
                                                              ...
                                                              Row(
                                                                ...
                                                                children: <
                                                                  ...
                                                                  Text(
                                                                    snapshot.data[0][0]['GerejaPelayanan'][0]
                                                                            [
                                                                            'paroki']
                                                                        as String,
                                                                    style: TextStyle(
                                ...
                                RaisedButton(
                                    ...
                                    onPressed: () async {
                                      showDirectionWithFirstMap(Coords(
                                          snapshot.data[0][0]['GerejaPelayanan']
                                              [0]['lat'],
                                          snapshot.data[0][0]['GerejaPelayanan']
                                              [0]['lng']));
                                    },
