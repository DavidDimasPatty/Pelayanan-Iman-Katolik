...
import 'package:pelayanan_iman_katolik/confirmRekoleksi.dart';
...
class detailDaftarRekoleksi extends StatelessWidget {
  final name;
  final email;
  var detailGereja;
  final idUser;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Pendaftaran Rekoleksi'),
        actions: <Widget>[
          IconButton(
                ...
                children: <Widget>[
                  ...
                  Center(
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                          onPressed: () async {
                            confirmRekoleksi(idUser, detailGereja[0]['_id'],
